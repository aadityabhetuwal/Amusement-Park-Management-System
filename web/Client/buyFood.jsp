    ...
    <div id="main-container" class="container-sm d-flex mt-5 flex-column align-items-center justify-content-center gap-2">
        ...
        <form action="" class="d-flex gap-2 flex-column ride-form form-control bg-light m-2">
            ...
            <div class="form-group">
                <label for="courtChoice" name="court-label" class="form-label">Select a food court</label>
                <select name="courtChoice" id="courtChoice" title="Select a food court" class="form-select ">
                    <option value="">Select a food court</option>
                    <option value="">Food court 1</option>
                    <option value="">Food court 2</option>
                    <option value="">Food court 3</option>
                </select>
            </div>
        </form>
            ...
            <div class="card card-size p-2 m-2">
                <div class="card-body">
                    <div class="d-flex align-content-center justify-content-start">
                        ...
                        <span class="display-5 card-title m-2">{Food name}</span>
                    </div>
