...
<body>
    ...
    <div id="main-container"
        ...
        <form class="container w-25 rounded border-dark bg-light p-5" action="adminVerify.jsp">
        ...
        <%
            ...
            if (request.getAttribute("valid") != null && request.getAttribute("valid").equals("invalid"))
                out.println("<div><small style='color:red'>Invalid admin number/password </small></div>");
        %>
